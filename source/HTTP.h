...
char dec_hex(unsigned len, unsigned rem){
	            char hex;
	            //int i;
				if (len != 0) {					
				//for (i = len-1; i > 0; i--){		
				switch(rem){
					case 10 : hex = 'A'; //index++; page[index] = 'A';
					break;
					case 11 : hex = 'B'; //index++; page[index] = 'B';
					break;
					case 12 : hex = 'C'; //index++; page[index] = 'C';
					break;
					case 13 : hex = 'D'; //index++; page[index] = 'D';
					break;
					case 14 : hex = 'E'; //index++; page[index] = 'E';
					break;
					case 15 : hex = 'F'; //index++; page[index] = 'F';
					break;
					default : hex = rem+'0'; //index++; page[index] = hex[i];//char = int + 48
					break;
					//}			
				}
			}
