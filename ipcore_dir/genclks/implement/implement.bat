...
xst -ifn xst.scr
move genclks_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\genclks_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc genclks_exdes.ucf genclks_exdes

echo 'Running map'
map -timing -pr b genclks_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm genclks_exdes -w routed.ncd routed.vhd
cd ..
